...
# ~ --------------------------------------------------------------------------
# ~ *Script Python 3.7=>2.7 created with PyCharm by Darkozma @ Balandro Team
# ~ --------------------------------------------------------------------------
...
def pth_fixdir():
    ...
    if os.path.isdir('updates'):
        ...
        while not fix_isdir:
            fixdir = raw_input("Sorry, '%s' folder not found. Type your fixes folder name: \n" % fixdir)
            fix_isdir = os.path.isdir(fixdir)
...
def versions():
    ...
    addon_version = raw_input("Type addon version: \n")
    fix_version = raw_input("Type fix number: \n")
